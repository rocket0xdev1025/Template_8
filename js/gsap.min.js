!(function (t, e) {
      ...
      (((me = Context.prototype).add = function add(t, i, n) {
        function Gw() {
          ...
          return (
            ...
            n && (a.selector = cb(n)),
            (l = a),
            s((t = i.apply(a, arguments))) && a._r.push(t),
            (l = e),
            (a.selector = r),
            (a.isReverted = !1),
            t
    ...
    zr = function _renderSVGTransforms(t, e) {
      ...
      (d = parseFloat(d)),
        ...
        (v || y || T || b) &&
          ...
          (O = ia(O + y - (v * i + y * a) + b))),
        (u || h) &&
          ((x = ia(x + (u / 100) * (s = g.getBBox()).width)),
  ...
  (ze.utils.checkPrefix = mr),
    ...
    (dr[Rr[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Dr),
    ha(
